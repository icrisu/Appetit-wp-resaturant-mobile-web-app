 ...
 * generic CPT
 */
class AppetitGenericPostType {
	
	protected $settings;
	protected $cptHelper;
		
	//create custom post
	public function create($cptHelper){
		$this->settings = $cptHelper->getSettings();
		$this->cptHelper = $cptHelper;
		register_post_type($this->settings['post_type'], $cptHelper->getPostArgs());
	}
